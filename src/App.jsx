...
function App() {
  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path='/Logical/1' element={<div><Passnew/></div>}/>
        <Route path='/Logical/2' element={<div><Pass/></div>}/>
        <Route path='/Logical/3' element={<div><Button/></div>}/>
        <Route path='/Logical/4' element={<div><RandomColor/></div>}/>
      </Routes>
      <Routes>
