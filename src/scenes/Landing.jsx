        ...
        <div className='md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32'>
            {isAboveMediumScreens ? (
                <div className="relative z-0 ml-20 before:absolute before:-top-20 before:-left-20 before:rounded-t-[400px] before:w-full before:max-w-[400px] before:h-full before:border-2 before:border-blue before:z-[-1]">
                    <img className="hover:filter hover:saturate-200 duration-500 transition ease z-10 w-full max-w-[200px] md:max-w-[500px]" src="./src/assets/profile-image.png" alt="Profile" />
                </div>
            ) : (
                <img className="hover:filter hover:saturate-200 duration-500 ease z-10 w-full max-w-[400px] md:max-w-[600px]" src="./src/assets/profile-image.png" alt="Profile" />
            )}
        </div>
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{once: true, amount: 0.5}} transition={{duration:0.5}} variants={{
                    ...
                    <p className="text-5xl font-playfair z-10 text-center md:text-start">
                        ...
                        <span className="xs:relative xs:text-deep-blue xs:font-semibold z-20">
                            <img className="absolute max-w-[250px] -left-[25px] -top-[78px] z-[-1]" src="./src/assets/brush.png" alt="brush"/>
                            Chauhan
                        </span>
                    </p>
