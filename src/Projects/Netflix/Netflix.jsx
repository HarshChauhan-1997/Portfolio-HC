...
const Netflix = () => {
  return (
    <>
      ...
      <section
        id="Netflix"
        className="w-[100%] h-[90vh] bg-[url('https://assets.nflxext.com/ffe/siteui/vlv3/fc164b4b-f085-44ee-bb7f-ec7df8539eff/d23a1608-7d90-4da1-93d6-bae2fe60a69b/IN-en-20230814-popsignuptwoweeks-perspective_alpha_website_large.jpg')] bg-center bg-cover"
      >
        <div className="w-[100%] h-[100vh] bg-[rgba(0,0,0,0.5)]">
              ...
              <div className="flex justify-end gap-[25px]">
                <div className="relative">
                  <svg
                    ...
                    className="default-ltr-cache-0 e1mhci4z1 text-white absolute top-[8px] left-[5px]"
                    data-name="Globe"
                    aria-hidden="true"
                  >
                    <path
                  ...
                  <select
                    className="bg-black text-white font-medium p-[4px_8px] sm:p-[4px_20px] text-[0.95rem] w-[40px] sm:w-[100%] rounded-[3px] border-[1px] border-white"
                    name="lang"
                  >
                ...
                <button className="bg-[#E50914] text-white font-medium text-[0.95rem] p-[2px_10px] rounded-[3px]">
                  Sign in
                </button>
              </div>
            </div>
          ...
          <div className="max-w-[1170px] mx-auto text-white sm:py-[185px] py-[50px] flex flex-col justify-center items-center">
            <h1 className="sm:text-[48px] text-center sm:w-[1150px] sm:font-extrabold text-[25px] w-[250px] font-[750]">
              The biggest Indian hits. Ready to watch here from ₹ 149.
            </h1>
            <p className="text-center sm:text-[25px] text-[20px] leading-[57px]">
              Join today. Cancel anytime.
            </p>
            <p className="text-center text-[20px] w-[225px] sm:w-auto">
              Ready to watch? Enter your email to create or restart your
              membership.
            </p>
            <div className="m-[30px] mx-auto w-auto flex flex-col justify-center items-center gap-4 sm:inline-block space-x-3">
              <input
                className="sm:w-[330px] sm:h-[57px] w-[250px] h-[50px] bg-transparent border-white border-[1px] placeholder:pl-[10px] rounded-[5px]"
                type="text"
      ...
      <section className="w-[100%] border-t-[10px] border-[#232323] h-[80vh] border-b-[10px] bg-black flex justify-center">
        <div className="flex flex-col sm:flex-row w-auto justify-center items-center">
          <div className="text-white sm:w-[600px] w-[300px] text-center sm:text-left">
            <h1 className="sm:text-[50px] text-[25px] font-extrabold ">
              Enjoy on your TV
            </h1>
          ...
          <div className="relative z-0">
            ...
            />
            <video
              className="absolute sm:bottom-[110px] sm:left-[77px] sm:h-[250px] h-[125px] bottom-8 left-[10px] -z-10"
      ...
      <section className="w-[100%] border-[#232323] h-[80vh] border-b-[10px] bg-black flex justify-center">
        <div className="flex flex-col sm:flex-row w-auto justify-center items-center">
          <div className="relative z-0">
            <img
              className="sm:h-[400px] h-[200px]"
              src="https://occ-0-2164-769.1.nflxso.net/dnm/api/v6/19OhWN2dO19C9txTON9tvTFtefw/AAAABVr8nYuAg0xDpXDv0VI9HUoH7r2aGp4TKRCsKNQrMwxzTtr-NlwOHeS8bCI2oeZddmu3nMYr3j9MjYhHyjBASb1FaOGYZNYvPBCL.png?r=54d"
              alt=""
            />
          </div>
          <div className="text-white sm:w-[600px] w-[300px] text-center sm:text-left">
