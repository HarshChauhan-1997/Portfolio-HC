...
const RandomColor = () => {
  ...
  return (
    <>
    <div className="w-full h-screen flex justify-center items-center easy-in duration-500" style={{backgroundColor: color}}>
        <div className="w-[400px] h-[80px] border-black border-[1px] rounded-md flex flex-col gap-2 bg-white">
            <p idName='text' className="text-center font-bold text-xl text-black">{newCode}</p>
            <button onClick={() => setColor(newCode)} className="bg-blue-500 h-[40px] mx-[10px] rounded border-[1px] border-black text-black font-bold">Click Me</button>
        </div>
